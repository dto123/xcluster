...
dataset_file=$XCLUSTER_ROOT/data/Autoencoder_final_data_glass_dim_2_twoHL_dprime2.tsv
dataset_name=Autoencoder_final_data_glass_dim_2_twoHL_dprime1.tsv
...
for i in `seq 1  $num_runs`
    do
        algorithm_name="Perch on AutoEncoder Data with dim 9 d1"
